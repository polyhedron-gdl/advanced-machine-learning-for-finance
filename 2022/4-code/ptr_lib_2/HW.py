...
def hw_evol(rand, hw, Dt, L, N):
    ...
    '''
    hw     : The Hull+White model
    L      : number of steps in the trajectory
    Dt     : tenor of the trajectory
    N      : number of trajectories

    Evolution of the H+W model in the 'bank-account' numeraire
    The evolution is a joint evolution for the short rate and the integral of the short rate
    '''
